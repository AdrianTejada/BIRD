...
export default function Home() {
  ...
  const [title, setTittle] =useState("Our Goal " )
    const [content, setContent] =useState("BCovid-action is an app designed to educated its users about the COVID-19 Virus. For those who want to take action or test their knowlage, there are also Donation links and quizes.")
